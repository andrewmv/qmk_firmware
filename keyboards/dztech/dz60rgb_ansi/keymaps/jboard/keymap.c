...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi(
        KC_GESC,        KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_MINS, KC_EQL,  KC_BSPC,
        KC_TAB,         KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_LBRC, KC_RBRC, KC_BSLS,
        KC_J,           KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J   , KC_J   ,          KC_ENT,
        KC_LSFT,                 KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_J,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
